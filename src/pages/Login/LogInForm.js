    ...
    return (
        ...
        <div className="flex md:w-1/1 justify-center py-10 pt-12 items-center bg-white">
            <form className="bg-white">
                ...
                {error && <p className="text-ted-500">{error}</p>}
                <button type="submit" className="block w-full bg-indigo-600 mt-4 py-2 rounded-2xl text-white font-semibold mb-2" onClick={handleLogin} disabled={loading}>Login</button>
            </form>
        </div>
